...
Public Class _PrintingSubAssyRawMaterial
    Dim label As ILabel

    Dim printers As IList(Of IPrinter)
    Dim selected_Printer As IPrinter
    Private Sub _PrintingSubAssyRawMaterial_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        InitializePrintEngine()

        Dim appPath As String = Application.StartupPath()
        label = PrintEngineFactory.PrintEngine.OpenLabel(appPath & "\Label\" & "Sub Assy Raw Material.nlbl")
    ...
    Private Sub isi_data()
        ...
        label.Variables("Batch_No").SetValue(txt_Batch_no.Text)
    ...
    Private Sub Clear_data()
        ...
        label.Variables("Batch_No").SetValue("")
        label.Variables("lot_no").SetValue("")

        label.Variables("qr_code").SetValue("")
    End Sub

    Private Sub _PrintingSubAssyRawMaterial_Closed(sender As Object, e As EventArgs) Handles Me.Closed
