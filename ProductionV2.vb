...
Public Class ProductionV2
    ...
    Sub tampilDataComboBoxLine()
        ...
        Dim dtMasterLine As DataTable = Database.GetData("select line as name from SUB_SUB_PO ssp JOIN main_po mp on mp.id=ssp.main_po and mp.department ='" & globVar.department & "' where ssp.status='Open' order by ssp.line")
